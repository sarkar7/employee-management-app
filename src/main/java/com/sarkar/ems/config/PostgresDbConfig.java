...
@ConditionalOnProperty(prefix = "enable.postgres.database", name = "postgres-db-switch", havingValue = "true")
public class PostgresDbConfig {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setDriverClassName(Objects.requireNonNull(environment.getProperty("postgres.datasource.driverClassName")));
